...
const getURIof = (item = '', lang = 'en') => {
  const URIof = {
    ...
    'Vue CLI': {
      en: 'https://cli.vuejs.org/guide/',
      ru: 'https://cli.vuejs.org/ru/guide/',
      zh: 'https://cli.vuejs.org/zh/guide/',
    },
    Vuex: {
      en: 'https://vuex.vuejs.org/guide/',
      ru: 'https://vuex.vuejs.org/ru/guide/',
      zh: 'https://vuex.vuejs.org/zh/guide/',
    },
    'Vue Router': {
      en: 'https://router.vuejs.org/guide/',
      ru: 'https://router.vuejs.org/ru/guide/',
      zh: 'https://router.vuejs.org/zh/guide/',
    },
    'Vue SSR': {
      en: 'https://ssr.vuejs.org/guide/',
      ru: 'https://ssr.vuejs.org/ru/guide/',
      zh: 'https://ssr.vuejs.org/zh/guide/',
    },
    Vuetify: {
      en: 'https://vuetifyjs.com/en/getting-started/quick-start',
      ru: 'https://vuetifyjs.com/ru/getting-started/quick-start',
      zh: 'https://vuetifyjs.com/zh/getting-started/quick-start',
    },
    'Nuxt.js': {
